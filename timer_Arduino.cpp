...
volatile uint8_t coreTimerTrigger= 0;
...
******************************************************************************/
{
  ...
  TCCR1A= 0; // Normal mode, Normal port operation (OC1A/OC1B disconnected)
  TCCR1B= 1 << CS11 | 1 << CS10; // no input capture, clock divide by 64: 16MHz/64 -> 4us interval
