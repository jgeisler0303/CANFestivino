...
/* index 0x6403 :   Mapped variable Read Analogue Input Float */
                    ...
                    subindex ObjDict_Index6403[] = 
                     {
                       { RO, CANopen_TYPE_uint8, sizeof (UNS8), (void*)&ObjDict_highestSubIndex_obj6403 },
                       { RO, CANopen_TYPE_real32, sizeof (REAL32), (void*)&Read_Analogue_Input_Float[0] },
                       { RO, CANopen_TYPE_real32, sizeof (REAL32), (void*)&Read_Analogue_Input_Float[1] }
                     };
...
const indextable ObjDict_objdict[] = 
{
  ...
  { (subindex*)ObjDict_Index6403,sizeof(ObjDict_Index6403)/sizeof(ObjDict_Index6403[0]), 0x6403},
};
...
const indextable * ObjDict_scanIndexOD (UNS16 wIndex, UNS32 * errorCode, ODCallback_t **callbacks)
{
	...
	*callbacks = NULL;
	switch(wIndex){
		...
		case 0x1801: i = 17;*callbacks = ObjDict_Index1801_callbacks; break;
		case 0x1A00: i = 18;break;
		case 0x1A01: i = 19;break;
		case 0x6000: i = 20;break;
		case 0x6002: i = 21;break;
		case 0x6003: i = 22;break;
		case 0x6005: i = 23;break;
		case 0x6006: i = 24;break;
		case 0x6007: i = 25;break;
		case 0x6008: i = 26;break;
		case 0x6200: i = 27;break;
		case 0x6202: i = 28;break;
		case 0x6206: i = 29;break;
		case 0x6207: i = 30;break;
		case 0x6403: i = 31;break;
		default:
